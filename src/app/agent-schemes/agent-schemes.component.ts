...
@Component({
  selector: 'app-agent-schemes',
  templateUrl: './agent-schemes.component.html',
  styleUrls: ['./agent-schemes.component.css']
})
export class AgentSchemesComponent {
  ...
  buyPolicy(scheme: any) {
    ...
    this.router.navigateByUrl('/agents-policy/' + scheme.schemeId)
  }
